...
# --------------------------------[ Datos muestreados ]--------------------------------
x_0 = torch.linspace(-15, 15, 20, device=device)
y_0 = torch.linspace(-15, 15, 20, device=device)
...
x_RBF = torch.linspace(-15, 15, step, device=device)
y_RBF = torch.linspace(-15, 15, step, device=device)
...
frames = 120
steps = torch.linspace(0, 40, frames)
delay = 0
