...
x_0 = torch.linspace(-5, 5, 15)
y_0 = torch.linspace(-5, 5, 15)
...
interpolator = RBF_Interpolator.RBFInterpolator3D_Alt("multiQuad", x_0, y_0, f=z, r=radius)

# Interpolación
step = 40

x_RBF = torch.linspace(-5, 5, step)
y_RBF = torch.linspace(-5, 5, step)
