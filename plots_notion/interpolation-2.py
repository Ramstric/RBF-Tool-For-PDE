...
fig = px.scatter(df, x="t", y="T")  # Fig 0 - Scatter plot
fig.update_traces(marker=dict(color=custom_colors["Red"], size=10, symbol="x"))

fig.add_trace(go.Scatter(x=np.linspace(0, 7, 300), y=temperatura[0]*gaussian(np.linspace(0, 7, 300), 1, 0.2), mode="lines", line=dict(color=custom_colors["Blue"]), showlegend=False))      # Fig 1 - Line plot

fig.add_trace(go.Scatter(x=np.linspace(0, 7, 300), y=temperatura[1]*gaussian(np.linspace(0, 7, 300), 2, 0.2), mode="lines", line=dict(color=custom_colors["Orange"]), showlegend=False))    # Fig 2 - Line plot

fig.add_trace(go.Scatter(x=np.linspace(0, 7, 300), y=temperatura[2]*gaussian(np.linspace(0, 7, 300), 3, 0.2), mode="lines", line=dict(color=custom_colors["Green"]), showlegend=False))     # Fig 3 - Line plot

fig.add_trace(go.Scatter(x=np.linspace(0, 7, 300), y=temperatura[3]*gaussian(np.linspace(0, 7, 300), 4, 0.2), mode="lines", line=dict(color=custom_colors["Rose"]), showlegend=False))      # Fig 4 - Line plot

fig.add_trace(go.Scatter(x=np.linspace(0, 7, 300), y=temperatura[4]*gaussian(np.linspace(0, 7, 300), 5, 0.2), mode="lines", line=dict(color=custom_colors["Purple"]), showlegend=False))    # Fig 5 - Line plot

fig.add_trace(go.Scatter(x=np.linspace(0, 7, 300), y=temperatura[5]*gaussian(np.linspace(0, 7, 300), 6, 0.2), mode="lines", line=dict(color=custom_colors["Gold"]), showlegend=False))      # Fig 6 - Line plot
...
fig.write_image("interpolation-2.png", scale=2)
